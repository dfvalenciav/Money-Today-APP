...
import com.davalIndustries.daval.moneytoday.dataMoneyToday.objSimuladorCredito

class SimuladorInverViewModel (creditoReq : Double, interesReq: Double, _plazoReq:Int ) : ViewModel() {
